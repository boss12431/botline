...
cl = LINETCR.LINE()
cl.login(token="ErbQcawEeMHkVUf7VCA1.lFlYEVKyBGxotJkRw8mhuq.GsnHk61M/9hwx+HY+fHB09IrIpj4JPrEXPKS85+lkrs=")
cl.loginResult()

ki1 = LINETCR.LINE()
ki1.login(token="ErbADrT1thVyNWfic3r3.cCPJofagOBuGmW2feAVtGW.q7f1kZ1EzzqaRW4Czz1gMi6AtsUVIkuVL8ngBFZbbsc=")
ki1.loginResult()

ki2 = LINETCR.LINE()
ki2.login(token="ErNgIRutSgVmdmCcOIX0.NoJBVou/clbKnCNk8x6fqa.EQUjpKwbbahLSurxD1ZggGT3eel6yz8esQrXvw1o+VE=")
ki2.loginResult()

ki3 = LINETCR.LINE()
ki3.login(token="ErJwsdjRzGl9O0R0Rhuc.pMkZbzIGF537zx3AcK17+a.Mc1Mxao+rNtcqGMLI6CJT9BtaKOauxjOTt/I84r1do0=")
ki3.loginResult()

ki4 = LINETCR.LINE()
ki4.login(token="ErYCNaVrPqOLIQejjv53.wh85rItPr2dRrYpngYyAuW.8VH6LipAiUhmfEG5emQuDpE0tE8vqNahIg4flpCe9wU=")
ki4.loginResult()

ki5 = LINETCR.LINE()
ki5.login(token="Ergcilt14Pa69SM0ZwQd.2Vlp0tJhiPL82sX7Bjivtq.2DKyo4JIn5TcUlsCLMvbmRA4VoaSpbCmZOh2pNVIZDc=")
ki5.loginResult()
...
helpMessage ="""By:─━═অईທີມບວທຍມທູຕইঅ═━─
   ╔════════════
   ║     [🐈 ชุดคำสั่ง ที่ 1 🐈]      ║
   ╚════════════
╔═════════
...
targets = []
mid = cl.getProfile().mid
Bots = ["u2df2f27af9186e05ce4e32ab5bc30751",mid]
self = ["u2df2f27af9186e05ce4e32ab5bc30751",mid]
admin = "u2df2f27af9186e05ce4e32ab5bc30751"
admsa = "u2df2f27af9186e05ce4e32ab5bc30751"
owner = "u2df2f27af9186e05ce4e32ab5bc30751"
adminMID = "u2df2f27af9186e05ce4e32ab5bc30751"
Creator="u2df2f27af9186e05ce4e32ab5bc30751"
wait = {
    "alwayRead":False,
    "detectMention":True,    
    "kickMention":False,
    ...
    'message':"Thanks for add Me By:─━═অईທີມບວທຍມທູຕইঅ═━─",
    "lang":"JP",
...
#----------------------------------------------------------------------------
                ...
                msg.contentType = 13
                adm = 'uf9e10ca494372ccecb4b3f6141ac6d29'
                msg.contentMetadata = {'mid': adm}
                cl.sendMessage(msg)
                cl.sendText(msg.to,"Add Line http://line.me/ti/p/vhUuKI5utL")
...
#==================================================
                ...
                if msg.toType == 2:
                    ...
                    try:
                        ...
                        ki9.sendText(msg.to,"Bye~Bye 􀜁􀄯?"  +  str(ginfo.name)  + "\n\n[By:─━═অईທີມບວທຍມທູຕইঅ═━─]")
                ...
                cl.sendText(msg.to,"""[🔥─━═অईທີມບວທຍມທູຕইঅ═━─🔥]\n\n
คำสั่งบอท siri
...
#==================================================
                ...
                cl.sendText(msg.to,""" 􀜁􀇔􏿿􀜁􀇔􏿿[─━═অईທີມບວທຍມທູຕইঅ═━─] 􀜁􀇔􏿿􀜁􀇔􏿿 \n\n 􀜁􀇔􏿿 key Only Kicker 􀜁􀇔􏿿 \n\n􀜁􀇔􏿿[Kb1 in]\n􀜁􀇔􏿿[1Aditname:]\n􀜁􀇔􏿿[B Cancel]\n􀜁􀇔􏿿[kick @]\n􀜁􀇔􏿿[Ban @]\n􀜁􀇔􏿿[kill]\n􀜁􀇔􏿿[BotChat]\n􀜁􀇔􏿿[Respons]\n􀜁􀇔􏿿[Pb1 Gift]\n􀜁􀇔􏿿[Pb1 bye]\n\n
""")
                ...
                ki1.sendText(msg.to,"ຍມທູຕ 1 􀜁􀅔􏿿🇹🇭")                
                ki2.sendText(msg.to,"ຍມທູຕ 2 􀜁􀅔􏿿🇹🇭")
                ki3.sendText(msg.to,"ຍມທູຕ 3 􀜁􀅔􏿿🇹🇭")
                ki4.sendText(msg.to,"ຍມທູຕ 4 􀜁􀅔􏿿🇹🇭")
                ki5.sendText(msg.to,"ຍມທູຕ 5 􀜁􀅔􏿿🇹🇭")
                ki6.sendText(msg.to,"ຍມທູຕ 6 􀜁􀅔􏿿🇹🇭")
                ki7.sendText(msg.to,"ຍມທູຕ 7 􀜁􀅔􏿿🇹🇭")
                ki8.sendText(msg.to,"ຍມທູຕ 8 􀜁􀅔􏿿🇹🇭")
                ki9.sendText(msg.to,"ຍມທູຕ 9 􀜁􀅔􏿿🇹🇭")
                ki10.sendText(msg.to,"ຍມທູຕ 10 􀜁􀅔􏿿🇹🇭")
...
#===============================================
                ...
                ki.sendText(msg.to, "[Ҩఖণಖஇ↭ধัюӄՁ่গს]\n\n❂͜͡☆➣ Namelock on\n❂͜͡☆➣ Namelock off\n❂͜͡☆➣ Blockinvite on\n❂͜͡☆➣ Blockinvite off\n❂͜͡☆➣ Backup on\n❂͜͡☆➣ Backup off\n\n[By.เพชร ทีมทดลองบอท]")
...
#-------------------------------------------------
                ...
                msg.contentType = 13
                cl.sendText(msg.to, "AdminBoss")
                msg.contentMetadata = {'mid': 'uf9e10ca494372ccecb4b3f6141ac6d29'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "AdminFram")
                msg.contentMetadata = {'mid': 'u9cb2be222beba03c2f114c6d839d4371'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "AdminTHIRD")
                msg.contentMetadata = {'mid': 'ueacedbe88bf6e2c5cf6188b3a4a26e18'}
                cl.sendMessage(msg)
                cl.sendText(msg.to, "AdminMos")
                msg.contentMetadata = {'mid': 'u574161f2ff3b234567b071c21b515a35'}
                cl.sendMessage(msg)
        ...
        if op.type == 26:
            ...
            if msg.text.lower() in ["1123"]:
                ...
                cl.sendMessage(cnt)
                        ...
                        cl.sendText(msg.to,"มีเรา...มีเธอ...มีกัน...ตลอดไป...")       
            elif "." == msg.text.lower():
                if msg.to in wait2['readPoint']:
                        try:
                            del wait2['readPoint'][msg.to]
